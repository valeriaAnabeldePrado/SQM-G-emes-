...
export default function SectionThree() {
  return (
    <div className="py-[var(--pading-y)] flex flex-col min-d:flex-row gap-10">
      <div
        className="flex-1/3 
        
"
      >
        <h3 className="text-(length:--text-subtitle)  text-[var(--color-three)] pb-16 min-note:leading-20">
