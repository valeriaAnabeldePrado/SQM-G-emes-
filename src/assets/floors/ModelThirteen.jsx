...
const ModelThirteen = ({ onEventApartment, selectedApartment, selectedFloor = 'p03' }) => {
  // Extraer el número de piso del selectedFloor
  const floorNumber = selectedFloor ? selectedFloor.slice(1, 3) : '03'
  ...
  return (
    ...
    >
      ...
      {/* SVG superpuesto para interactividad - usando el SVG original del ModelOne adaptado */}
      <svg
