import './models.css'
const ModelOne = ({ onEventApartment, selectedApartment }) => {
  return (
    <>
      <svg
      ...
      >
        <g id="Capa_1-2" data-name="Capa 1">
          ...
          <g
            ...
            onClick={(e) => {
              e.stopPropagation()
              onEventApartment('apartment_A_P1')
            }}
          >
            <polygon
              className="apartment-surface"
              fill={selectedApartment === 'apartment_A_P1' ? '#ffc46a' : '#c6c7c9'}
              points="107.64 0 107.64 185.16 0 185.16 0 19.8 54.6 19.8 54.6 0 107.64 0"
            />
            <g id="A_p1">
              <path
                className="apartment-text"
                fill={selectedApartment === 'apartment_A_P1' ? '#483b2b' : '#c6c7c9'}
          ...
          <g
            ...
            onClick={(e) => {
              e.stopPropagation()
              onEventApartment('apartment_D_P1')
            }}
          >
            <rect
              className="apartment-surface"
              fill={selectedApartment === 'apartment_D_P1' ? '#ffc46a' : '#c6c7c9'}
              y="245.88"
              width="107.64"
              height="164.88"
            />
            <g id="D_P1">
              <path
                className="apartment-text"
                fill={selectedApartment === 'apartment_D_P1' ? '#483b2b' : '#c6c7c9'}
          ...
          <g
            ...
            onClick={(e) => {
              e.stopPropagation()
              onEventApartment('apartment_B_P1')
            }}
          >
            <polygon
              className="apartment-surface"
              fill={selectedApartment === 'apartment_B_P1' ? '#ffc46a' : '#c6c7c9'}
              points="218.28 19.8 218.28 185.16 110.64 185.16 110.64 0 163.68 0 163.68 19.8 218.28 19.8"
            />
            <g id="B_P1">
              <path
                className="apartment-text"
                fill={selectedApartment === 'apartment_B_P1' ? '#483b2b' : '#c6c7c9'}
          ...
          <g
            ...
            onClick={(e) => {
              e.stopPropagation()
              onEventApartment('apartment_C_P1')
            }}
          >
            <rect
              className="apartment-surface"
              fill={selectedApartment === 'apartment_C_P1' ? '#ffc46a' : '#c6c7c9'}
              x="110.64"
              y="245.88"
              width="107.64"
              height="164.88"
            ...
            <g id="C_P1">
              <path
                className="apartment-text"
                fill={selectedApartment === 'apartment_C_P1' ? '#483b2b' : '#c6c7c9'}
          ...
          >
            <rect
              ...
              width="218.28"
              height="130.56"
              fill={selectedApartment === 'Oficina_P1' ? '#ffc46a' : '#c6c7c9'}
            />
            <g id="Oficina_P1">
              <path
                className="apartment-text"
                fill={selectedApartment === 'Oficina_P1' ? '#483b2b' : '#c6c7c9'}
