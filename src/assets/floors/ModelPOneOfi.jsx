...
const ModelPOneOfi = ({ onEventApartment, selectedApartment, selectedLetter }) => {
  const [hoveredApartment, setHoveredApartment] = useState(null)

  const apartmentIds = {
    OFICINA: 'oficina_p1_P1'
  }
  ...
  return (
    ...
    >
      <img
        src="/planos/ofiPisoUno/ofiPisoUno.png"
        alt="Piso uno oficina"
        style={{
          position: 'absolute',
          top: 0,
          left: 0,
