...
const ModelPTreeOfi = ({ onEventApartment, selectedApartment, selectedLetter }) => {
  //const floorNumber = 'pisoTresOficina'

  const [hoveredApartment, setHoveredApartment] = useState(null)

  const apartmentIds = {
    OFICINA: 'oficina_p3_P3'
  }
  ...
  return (
    ...
    >
      <img
        src="/planos/ofiPisoTres/ofiPisoTres.png"
        alt="Piso tres oficina"
        style={{
          position: 'absolute',
          top: 0,
          left: 0,
