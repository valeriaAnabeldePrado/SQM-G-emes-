import './models.css'
const ModelOne = ({ onEventApartment, selectedApartment, selectedFloor = 'p01' }) => {
  // Extraer el número de piso del selectedFloor (p01, p02, p03)
    ...
    <>
      ...
      >
        <g id="Capa_1-2" data-name="Capa 1">
          <rect className="cls-3" y="188.16" width="180.6" height="54.36" />
          <g
            id={apartmentIds.A}
