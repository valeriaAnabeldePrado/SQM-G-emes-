          ...
          <section className="flex  h-[30%] gap-[var(--generic-gap-tablet)] min-d:gap-[var(--generic-gap-desktop)] min-d:flex-1">
            <Card hasGradient className="w-full min-d:flex-1flex flex-col">
              ...
              <div className="flex-1 w-full">
                <h3 className="min-note:text-body text-button text-white">
          ...
          <section className="flex h-[15%] gap-[var(--generic-gap-tablet)] min-d:gap-[var(--generic-gap-desktop)] min-d:flex-1">
            <Card hasGradient className="w-full min-d:flex-1flex flex-col ">
              ...
              <div className="flex items-center w-full gap-5">
                ...
                <h3 className="text-white min-note:text-body text-button">Nuestro instagram</h3>
              </div>
            </Card>
          </section>
          <section className="flex h-[15%] gap-[var(--generic-gap-tablet)] min-d:gap-[var(--generic-gap-desktop)] min-d:flex-1">
            <Card hasGradient className="w-full min-d:flex-1flex flex-col ">
              ...
              <div className="flex gap-5 items-center w-full">
                ...
                <h3 className="text-white min-note:text-body text-button">Contacto</h3>
              </div>
            </Card>
          </section>
          <section className="flex h-[15%] gap-[var(--generic-gap-tablet)] min-d:gap-[var(--generic-gap-desktop)] min-d:flex-1">
            <Card hasGradient className="w-full min-d:flex-1flex flex-col ">
              ...
              <div className="flex gap-5 items-center w-full">
                ...
                <h3 className="text-white min-note:text-body text-button">Ubicación</h3>
              </div>
            </Card>
          </section>
        </div>
